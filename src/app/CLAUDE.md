...
- `bedrock/page.tsx` — Bedrock 모니터링 (모델별 사용량, 비용, 토큰, Prompt Caching)
...
| `api/bedrock-metrics/route.ts` | Bedrock 모델 사용량/비용 (CloudWatch AWS/Bedrock) |
...
- `bedrock/page.tsx` — Bedrock Monitoring (per-model usage, cost, tokens, Prompt Caching)
...
| `api/bedrock-metrics/route.ts` | Bedrock model usage/cost (CloudWatch AWS/Bedrock) |
